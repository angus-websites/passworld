...
<x-app-layout>
  <div class="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:my-16 lg:my-20 lg:px-8 xl:my-25">
    ...
    <x-button-group class="mt-5 sm:mt-10 justify-center">
      <!--Left button-->
      <button disabled="disabled" class="btn btn-primary btn-lg space-x-1">
        <!--Refresh Icon-->
  ...
  <script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
      function runSearch(){
        $("#generate svg").addClass("animate-reverse-spin")
        $.ajax({
          type:"GET",
          url: '/quick_ass',
          ...
          complete: function() {
            $("#generate svg").removeClass("animate-reverse-spin")
          }
